	...
	<div class="w-full max-w-md">
		<div class="bg-white/30 dark:bg-gray-800/30 backdrop-blur-md border border-white/20 dark:border-gray-700/20 shadow-lg rounded-2xl p-8">
			<div class="text-center mb-8">
				...
				<p class="text-gray-600 dark:text-gray-300">Join us today</p>
			</div>
			...
			<div class="space-y-3 mb-6">
				<button
					...
					class="w-full flex items-center justify-center px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
				>
			...
			<div class="relative mb-6">
				...
				<div class="relative flex justify-center text-sm">
					<span class="px-2 bg-white/30 dark:bg-gray-800/30 text-gray-500 dark:text-gray-400">Or continue with</span>
				</div>
			</div>
			...
			<form on:submit|preventDefault={handleSubmit} class="space-y-6">
				<div>
					...
					<div class="relative">
						...
						<input
							...
							bind:value={name}
							required
							class="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-md bg-white/50 dark:bg-gray-700/50 backdrop-blur-sm text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
				...
				<div class="flex items-center">
					...
					<label for="terms" class="ml-2 block text-sm text-gray-700 dark:text-gray-300">
						I agree to the
						<a href="/terms" class="text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300">
							Terms of Service
						</a>
						and
						<a href="/privacy" class="text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300">
							Privacy Policy
						</a>
					</label>
				</div>
