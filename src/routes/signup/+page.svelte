		...
		>
			...
			<div class="relative mb-6">
				...
				<div class="relative flex justify-center text-sm">
					<span class="bg-white/30 px-2 text-gray-500 dark:bg-gray-800/30 dark:text-gray-400"
				...
				<div>
					...
					<div class="relative">
						...
						<input
							...
							bind:value={name}
							required
							class="w-full rounded-md border border-gray-300 bg-white/50 py-3 pr-4 pl-10 text-gray-900 placeholder-gray-500 backdrop-blur-sm transition-colors focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700/50 dark:text-white dark:placeholder-gray-400"
